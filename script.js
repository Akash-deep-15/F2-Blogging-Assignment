...
function displayBlogPosts() {
  ...
  blogPosts.forEach((blogPost, index) => {
    ...
    const blogPostElementBottom = document.createElement('div');
    blogPostElementBottom.appendChild(editBtn);
    blogPostElementBottom.appendChild(deleteBtn);
    blogPostElementBottom.appendChild(dateTimeElement);
    blogPostElement.appendChild(blogPostElementBottom);
...
function displayEditBlogPosts() {
  ...
  blogPosts.forEach((blogPost, index) => {
    ...
    const dateTimeElement = document.createElement('p');
    const dateTimeString = blogPost.dateTime.toLocaleString();
    dateTimeElement.textContent = `Updated on ${dateTimeString}`;
    dateTimeElement.classList.add('dateTime');
    const deleteBtn = document.createElement('button');
    deleteBtn.textContent = 'Delete';
    deleteBtn.dataset.index = index;
